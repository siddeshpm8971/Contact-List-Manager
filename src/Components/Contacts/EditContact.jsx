...
const EditContact = () => {
    ...
    useEffect(async()=>{
        try{
            ...
            let groupresponse = await axios.get(`http://localhost:5000/groups`);
    ...
    let submitFun = async(e) => {
        e.preventDefault();
        let response = await axios.put(`http://localhost:5000/contacts/${contactId}`,contact);
        if(response){
        ...
        <React.Fragment>
            ...
            <section className='edit-contact'>
                <div className="container p-3">
                    <div className="row">
                        <div className="col">
                            <h1 className='text-primary fw-bold'>Edit Contact</h1>
